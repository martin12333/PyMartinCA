...
bmin=3 ##24 ##23.5 ##2.60 #70 #60 #50 ##6.5 ###7*(beta70 - d691) ##2.98 #3*beta70 #xx #3

xlo=3 #4 #3 ##23 ##22.5 ##2.5 #2.9 #2.8 #2.5 #2
xhi=xlo + 1 #5 #6 ##45 ##45.5   ##5 #3.6 #4.1 #4.2 #4.5 #5 #10


smin=3 ##31 ##30.5 ##3.35 #25 #15 #01 #2.9 #8 #7  #20 #30 #40 #50 ##6.5 ###7*(beta70 - d691) #8  ##2.98 #3*beta70 #yy - 1 #smin = 3

ylo=4 #3 ##28 ##27.5 ##3 # 4.4 #4.2  #3 #3.9 #3.8
yhi=ylo + 1 #4 #5 #6 ##54 ##54.5 ##6 #4.3 #4.8  #6 #5.1 #5.2 #10


#diam =5 
#xlo= 7 #9 ##7
#xhi=7.08 #11 #2 #5 #8 #9 #12 ##11
#ylo= 11.03 #01 #10.99 #95 #8 #10.5 #10 #9 ##8 #10
#yhi= 11.08 #05 #2 #5 #12 #13 ##12


#=============================
h=300 #40 #100 #950 #1040 #h=180 #h=730 #h=360 #w=h*2
w=h
...
niter = 300#200 #400 #200 #1000 #3000   
sli=0 #0.1 #0 #0.01
skipy=8#4 #20 #8 #5 #1 #37 #2
skip2=60 #120
