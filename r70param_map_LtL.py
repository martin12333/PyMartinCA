...
xhi=3.6 #4.1 #4.2 #4.5 #5
ylo= 3.7 #4.2  #3 #3.9 #3.8
yhi= 4.3 #4.8  #6 #5.1 #5.2

beta70=0.83 #85  ##0.80 #0.85 #0.90 #0.93 #0.96 #0.97 #0.98 #1 #0.99 #1.0
nbeta70 = 1-beta70
...
d701=   0.15 #13 #11   ##0.24  #0.12  #0.06  #0.02
blo=3*beta70 - d701 ##2.98 #3*beta70 #xx #3
bhi=xx
slo=3*beta70 - d701 ##2.98 #3*beta70 #yy - 1 #slo = 3
shi=yy
