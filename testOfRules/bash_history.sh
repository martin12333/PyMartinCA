 ...
 1770  git add -vv beta/testOfRules/output/*.csv bash_history.sh beta/testOfRules/*.py
 1771  git commit -vv  -a -m bkup-pre
 1772  git push -vv -u origin Jiri
 1773  mv -iv beta beta,07r
 1774  git clone --single-branch --branch=beta https://github.com/martin12333/PyMartinCA
 1775  mv -iv PyMartinCA beta
 1776  history -a ; history >bash_history.sh
 1777  mc
 1778  cd
 1779  cd grdr20/PyMartinCA/beta/
 1780  git add --verbose testOfRules/output/*.csv testOfRules/bash_history.sh testOfRules/*.py
 1781  git add --verbose testOfRules/output/*.csv testOfRules/*.sh testOfRules/*.py
 ...
 1870  cd grdr20/PyMartinCA/beta/testOfRules/
 1871  cd grdr20/PyMartinCA/beta/testOfRules/
 1872  history 
 ...
 1976  echo python3 testOfRules-from-csv-or-cube-or-random.py
 1977  mc
 1978  python3 testOfRules-from-csv-or-cube-or-random.418.py <lifelib-input/orig100-p100520.csv 
 1979  mc
 1980  history -a ; history >bash_history.sh; history|grep pyth
 1981  python3 3-testOfRules-from-csv-or-cube-or-random.418.py <lifelib-input/orig100-p100520.csv 
 1982  python3 testOfRules-407-from-csv-or-cube-or-random.py
 1983  mc
 1984  while true ; do sleep 1;  python3 testOfRules-407-from-csv-or-cube-or-random.py  ; done
 1985  history -a ; history >bash_history.sh; history|grep pyth
