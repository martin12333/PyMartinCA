...
### (the * first * time importing scipy into browser can take minutes)
...
((For help, type `alt+h` or press the :question: button.))
...
w=900#1850 #2000 #2250 #1800
h=450#950 #1300 #1400 #950
...
x11 = (np.linspace(xlo, xhi , w))
y11 = (np.linspace(yhi  , ylo, h))
