...
#=============================
bmin=24 ##23.5 ##2.60 #70 #60 #50 ##6.5 ###7*(beta70 - d691) ##2.98 #3*beta70 #xx #3
smin=31 ##30.5 ##3.35 #25 #15 #01 #2.9 #8 #7  #20 #30 #40 #50 ##6.5 ###7*(beta70 - d691) #8  ##2.98 #3*beta70 #yy - 1 #smin = 3
...
diam =3
xlo=  36 # 34 #26 #24 ##22.5 ##2.5 #2.9 #2.8 #2.5 #2
xhi=  39 # 40 #44 ##45.5   ##5 #3.6 #4.1 #4.2 #4.5 #5 #10
ylo=  47  #45 #41  #31 ##27.5 ##3 # 4.4 #4.2  #3 #3.9 #3.8
yhi= 49 #  50 #52 ##54.5 ##6 #4.3 #4.8  #6 #5.1 #5.2 #10
