...
dx52=0.4+3 #2.4
xlo=8#5#7####5##3 #4 #3 ##23 ##22.5 ##2.5 #2.9 #2.8 #2.5 #2
xhi=xlo +dx52#5.2#6#1 #5 #6 ##45 ##45.5   ##5 #3.6 #4.1 #4.2 #4.5 #5 #10

smin=8#7#3 ##31 ##30.5 ##3.35 #25 #15 #01 #2.9 #8 #7  #20 #30 #40 #50 ##6.5 ###7*(beta70 - d691) #8  ##2.98 #3*beta70 #yy - 1 #smin = 3
...
#=============================
scr52=400
h=scr52*dy52 #40 #100 #950 #1040 #h=180 #h=730 #h=360 #w=h*2
w=scr52*dx52
