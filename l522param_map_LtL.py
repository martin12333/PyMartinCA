...
xhi=xlo + 6#1 #5 #6 ##45 ##45.5   ##5 #3.6 #4.1 #4.2 #4.5 #5 #10

smin=7#3 ##31 ##30.5 ##3.35 #25 #15 #01 #2.9 #8 #7  #20 #30 #40 #50 ##6.5 ###7*(beta70 - d691) #8  ##2.98 #3*beta70 #yy - 1 #smin = 3

ylo=10-1#10-0.2#7##4 #3 ##28 ##27.5 ##3 # 4.4 #4.2  #3 #3.9 #3.8
yhi=ylo + 3#1.4#5##1 #4 #5 #6 ##54 ##54.5 ##6 #4.3 #4.8  #6 #5.1 #5.2 #10

#=============================
h=200*3 #40 #100 #950 #1040 #h=180 #h=730 #h=360 #w=h*2
w=200*6
